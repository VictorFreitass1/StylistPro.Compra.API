...
- Entrada: Requisição para listar compras. <br/>
- Processo: Recuperação dos dados das compras do banco de dados. <br/>
- Saída: Lista de compras com detalhes.

### ObterPorId: Retorna um registro específico com base no Id fornecido.
- Entrada: Id da compra a ser listada. <br/>
- Processo: Recuperação dos dados da compra do banco de dados <br/>
- Saída: Lista os detalhes da compra localizada pelo Id

### SalvarDados: Insere um novo registro no banco de dados.
- Entrada: Data da Compra e status da compra. <br/>
...
- Entrada: Id da compra e dados atualizados. <br/>
- Processo: Validação e atualização da compra no banco de dados. <br/>
- Saída: Confirmação da atualização

### DeletarDados: Remove um registro com base no Id.
- Entrada: Id da compra a ser excluída. <br/>
- Processo: Remoção da compra no banco de dados. <br/>
